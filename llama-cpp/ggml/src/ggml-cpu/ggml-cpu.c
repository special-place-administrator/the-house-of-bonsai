...
static const struct ggml_type_traits_cpu type_traits_cpu[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_RQ2_0] = {
        .from_float               = (ggml_from_float_t) quantize_row_rq2_0_ref,
        .vec_dot                  = NULL,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
    [GGML_TYPE_RQ3_0] = {
        .from_float               = (ggml_from_float_t) quantize_row_rq3_0_ref,
        .vec_dot                  = NULL,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
    [GGML_TYPE_RQ4_0] = {
        .from_float               = (ggml_from_float_t) quantize_row_rq4_0_ref,
        .vec_dot                  = NULL,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q1_0] = {
        .from_float               = (ggml_from_float_t) quantize_row_q1_0_ref,
        .vec_dot                  = ggml_vec_dot_q1_0_q8_1,
        .vec_dot_type             = GGML_TYPE_Q8_1,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q1_0_g128] = {
        .from_float               = (ggml_from_float_t) quantize_row_q1_0_g128_ref,
        .vec_dot                  = ggml_vec_dot_q1_0_g128_q8_1,
        .vec_dot_type             = GGML_TYPE_Q8_1,
        .nrows                    = 1,
    },
    [GGML_TYPE_I32] = {
...
static void ggml_compute_forward(struct ggml_compute_params * params, struct ggml_tensor * tensor) {
    ...
    switch (tensor->op) {
        ...
        case GGML_OP_RQ_ROTATE:
            {
                ggml_compute_forward_rq_rotate(params, tensor);
            } break;
